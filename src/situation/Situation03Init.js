Situation03.prototype.initStage = function (stageNumber, stage) {
    ...
    case 0:
        ...
        stage.notification().addNotificationCallback(sConstants.N03_01_CAR_INTRO, [
    ...
    case 1:
        ...
        stage.notification().addNotificationCallback(sConstants.N03_02_BIKE_INTRO, [
    ...
    case 2:
        ...
        stage.notification().addNotificationCallback(sConstants.N03_02_CAR_CONTINUE, [
        ...
        stage.notification().addNotificationCallback(sConstants.N03_03_BIKE_CONTINUE, [
    ...
    case 3:
        stage.addStartingVelocity(sConstants.OBJECT_BIKE, 0, -bikeSpeed);
        stage.addStartingVelocity(sConstants.OBJECT_CAR_A, carSpeed, 0, -300, 0);
        ...
        stage.notification().addNotificationCallback(sConstants.N03_04_COLLISION, [
    ...
    case 6:
        ...
        stage.notification().addNotificationCallback(sConstants.N03_06_BIKE_SLOW, [
                            "Widząc przejście,",
                            "rowerzysta zwalnia."
                            ], function () {
            this.notification().startNotification(
        ...
        stage.notification().addNotificationCallback(sConstants.N03_06_CAR_SLOW, [
                    "Kierowca również zmniejsza",
                    "prędkość, widząc, że przetnie",
                    "przejście dla pieszych."
                    ], function () {
            this.addEventVelocity(0, sConstants.OBJECT_BIKE, 0, -bikeSpeed, 0, 170);
        ...
        stage.notification().addNotificationCallback(sConstants.N03_06_BIKE_WALK, [
    ...
    case 7:
        ...
        stage.addCollisionHandler(sConstants.T03_08_CAR_CONTINUE, sConstants.OBJECT_BIKE,
            function () {
                this.addEventVelocity(0, sConstants.OBJECT_CAR_A, carSpeed / 8, 0, 500, 0);
